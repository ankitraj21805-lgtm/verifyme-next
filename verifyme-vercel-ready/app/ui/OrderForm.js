...
export default function OrderForm({ services }) {
  ...
  return <form className="card form" onSubmit={submit}>
    ...
    <input className="input" type="email" name="client_email" placeholder="Email for order confirmation" required />
    ...
    <small style={{ color: '#a1a1aa' }}>After submission you will get an Order ID, confirmation page, tracking page, and payment reference page.</small>
  </form>;
}
